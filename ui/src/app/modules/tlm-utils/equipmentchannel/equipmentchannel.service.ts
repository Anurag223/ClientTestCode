...
export class EquipmentChannelService extends DataService {
 ...
 * @memberof EquipmentChannelService
 */
    ...
    */
    getChannelData(
        ...
        super.WriteDebugLog('EquipmentChannelService => getChannelData as Iface');
        let encodedID = encodeURIComponent(equipment.wellKnownEntityId);
    ...
    */
    verifyEquipmentExistsInRegistry(equipment: Equipment): Observable<any[]> {
        super.WriteDebugLog('EquipmentChannelService => verify equipment exists in registry');
    ...
    registerEquipmentInRegistry(
       equipment: Equipment): Observable<EqRegistryResponse> {
        super.WriteDebugLog('EquipmentChannelService => regsiter equipment in registry');
