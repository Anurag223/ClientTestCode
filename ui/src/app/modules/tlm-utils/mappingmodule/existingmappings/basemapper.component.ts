...
import { BaseMapperService } from './basemapper.service';
...
@Component({
    selector: 'app-tlm-utils-existingmappings',
    templateUrl: './basemapper.component.html',
    styleUrls: ['./basemapper.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BaseMapperComponent extends BaseComponent
    ...
    constructor(
        ...
        public baseMapperService: BaseMapperService,
        private userProfileService: UserprofileService,
        private siteApi: SiteDetailsService,
        private router: Router,
    ) {
        super('BaseMapperComponent', loggerService);
    }
    ...
    public fetchEnabledSites(siteDetails) {
        let sites: any;
        // Get Enabled Sites
        this.baseMapperService.getEnabledSites().subscribe(
            (response: Array<any>) => {
    ...
    public fetchWhitelistedSites() {
        this.baseMapperService.getWhitelistedSites().subscribe(
            (response: Array<any>) => {
                if (response) {
