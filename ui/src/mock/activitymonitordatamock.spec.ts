import { IEquipmentRequest, IEquipmentDemandOrder } from '../app/modules/activitymonitor/models/activitymonitor/activitymonitor';

export const iequpimentDemandOrderMock: any = {
...
export const equipMentRequestObj: IEquipmentRequest = {
  ...
  sourceSystemId: 'QTRAC',
  sourceRecordId: '7428621',
  equipmentDemandOrders: [iequpimentDemandOrderMock],
  epicSummaries: [{
    epicKey: 'Rentals',
    equipmentCount: '1',
    status: 'Redirected',
